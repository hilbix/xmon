...
/* function prototypes: */
/* table11.c: */
static TYPE DefineType P((short typeid , short class , char *name , PrintHandlerType printproc ));
	...
	char   *name;
{
    ...
    p = (ValueListEntryType *)malloc((long)(sizeof(ValueListEntryType)));
    p->Name = name;
    p->Value = value;
    ...
    else
	{
	    ...
	    ValueListEntryType  *q = type->ValueList;
...
InitEnumeratedTypes()
{
    ...
    p = DefineType(REQUEST, ENUMERATED, "REQUEST", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(REPLY, ENUMERATED, "REPLY", NULL /* PrintENUMERATED */);
    DefineEValue(p, 3L, "GetWindowAttributes");
    DefineEValue(p, 14L, "GetGeometry");
    DefineEValue(p, 15L, "QueryTree");
    DefineEValue(p, 16L, "InternAtom");
    ...
    p = DefineType(ERROR, ENUMERATED, "ERROR", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(EVENT, ENUMERATED, "EVENT", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(BITGRAVITY, ENUMERATED, "BITGRAVITY", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(WINGRAVITY, ENUMERATED, "WINGRAVITY", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(BOOL, ENUMERATED, "BOOL", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "False");
    DefineEValue(p, 1L, "True");

    p = DefineType(HOSTFAMILY, ENUMERATED, "HOSTFAMILY", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Internet");
    DefineEValue(p, 1L, "DECnet");
    DefineEValue(p, 2L, "Chaos");

    p = DefineType(PK_MODE, ENUMERATED, "PK_MODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Synchronous");
    DefineEValue(p, 1L, "Asynchronous");

    p = DefineType(NO_YES, ENUMERATED, "NO_YES", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "No");
    DefineEValue(p, 1L, "Yes");
    DefineEValue(p, 2L, "Default");

    p = DefineType(WINDOWCLASS, ENUMERATED, "WINDOWCLASS", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "CopyFromParent");
    DefineEValue(p, 1L, "InputOutput");
    DefineEValue(p, 2L, "InputOnly");

    p = DefineType(BACKSTORE, ENUMERATED, "BACKSTORE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "NotUseful");
    DefineEValue(p, 1L, "WhenMapped");
    DefineEValue(p, 2L, "Always");

    p = DefineType(MAPSTATE, ENUMERATED, "MAPSTATE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Unmapped");
    DefineEValue(p, 1L, "Unviewable");
    DefineEValue(p, 2L, "Viewable");

    p = DefineType(STACKMODE, ENUMERATED, "STACKMODE", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(CIRMODE, ENUMERATED, "CIRMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "RaiseLowest");
    DefineEValue(p, 1L, "LowerHighest");

    p = DefineType(CHANGEMODE, ENUMERATED, "CHANGEMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Replace");
    DefineEValue(p, 1L, "Prepend");
    DefineEValue(p, 2L, "Append");

    p = DefineType(GRABSTAT, ENUMERATED, "GRABSTAT", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(EVENTMODE, ENUMERATED, "EVENTMODE", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(FOCUSAGENT, ENUMERATED, "FOCUSAGENT", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "None");
    DefineEValue(p, 1L, "PointerRoot");
    DefineEValue(p, 2L, "Parent");

    p = DefineType(DIRECT, ENUMERATED, "DIRECT", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "LeftToRight");
    DefineEValue(p, 1L, "RightToLeft");

    p = DefineType(GCFUNC, ENUMERATED, "GCFUNC", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(LINESTYLE, ENUMERATED, "LINESTYLE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Solid");
    DefineEValue(p, 1L, "OnOffDash");
    DefineEValue(p, 2L, "DoubleDash");

    p = DefineType(CAPSTYLE, ENUMERATED, "CAPSTYLE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "NotLast");
    DefineEValue(p, 1L, "Butt");
    DefineEValue(p, 2L, "Round");
    DefineEValue(p, 3L, "Projecting");

    p = DefineType(JOINSTYLE, ENUMERATED, "JOINSTYLE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Miter");
    DefineEValue(p, 1L, "Round");
    DefineEValue(p, 2L, "Bevel");

    p = DefineType(FILLSTYLE, ENUMERATED, "FILLSTYLE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Solid");
    DefineEValue(p, 1L, "Tiled");
    DefineEValue(p, 2L, "Stippled");
    DefineEValue(p, 3L, "OpaqueStippled");

    p = DefineType(FILLRULE, ENUMERATED, "FILLRULE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "EvenOdd");
    DefineEValue(p, 1L, "Winding");

    p = DefineType(SUBWINMODE, ENUMERATED, "SUBWINMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "ClipByChildren");
    DefineEValue(p, 1L, "IncludeInferiors");

    p = DefineType(ARCMODE, ENUMERATED, "ARCMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Chord");
    DefineEValue(p, 1L, "PieSlice");

    p = DefineType(RECTORDER, ENUMERATED, "RECTORDER", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "UnSorted");
    DefineEValue(p, 1L, "YSorted");
    DefineEValue(p, 2L, "YXSorted");
    DefineEValue(p, 3L, "YXBanded");

    p = DefineType(COORMODE, ENUMERATED, "COORMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Origin");
    DefineEValue(p, 1L, "Previous");

    p = DefineType(POLYSHAPE, ENUMERATED, "POLYSHAPE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Complex");
    DefineEValue(p, 1L, "Nonconvex");
    DefineEValue(p, 2L, "Convex");

    p = DefineType(IMAGEMODE, ENUMERATED, "IMAGEMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Bitmap");
    DefineEValue(p, 1L, "XYPixmap");
    DefineEValue(p, 2L, "ZPixmap");

    p = DefineType(ALLORNONE, ENUMERATED, "ALLORNONE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "None");
    DefineEValue(p, 1L, "All");

    p = DefineType(OBJECTCLASS, ENUMERATED, "OBJECTCLASS", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Cursor");
    DefineEValue(p, 1L, "Tile");
    DefineEValue(p, 2L, "Stipple");

    p = DefineType(OFF_ON, ENUMERATED, "OFF_ON", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Off");
    DefineEValue(p, 1L, "On");
    DefineEValue(p, 2L, "Default");

    p = DefineType(INS_DEL, ENUMERATED, "INS_DEL", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Insert");
    DefineEValue(p, 1L, "Delete");

    p = DefineType(DIS_EN, ENUMERATED, "DIS_EN", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Disabled");
    DefineEValue(p, 1L, "Enabled");

    p = DefineType(CLOSEMODE, ENUMERATED, "CLOSEMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Destroy");
    DefineEValue(p, 1L, "RetainPermanent");
    DefineEValue(p, 2L, "RetainTemporary");

    p = DefineType(SAVEMODE, ENUMERATED, "SAVEMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Reset");
    DefineEValue(p, 1L, "Activate");

    p = DefineType(RSTATUS, ENUMERATED, "RSTATUS", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Success");
    DefineEValue(p, 1L, "Busy");
    DefineEValue(p, 2L, "Failed");

    p = DefineType(MOTIONDETAIL, ENUMERATED, "MOTIONDETAIL", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Normal");
    DefineEValue(p, 1L, "Hint");

    p = DefineType(ENTERDETAIL, ENUMERATED, "ENTERDETAIL", NULL /* PrintENUMERATED */);
    ...
    p = DefineType(BUTTONMODE, ENUMERATED, "BUTTONMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Normal");
    DefineEValue(p, 1L, "Grab");
    DefineEValue(p, 2L, "Ungrab");
    DefineEValue(p, 3L, "WhileGrabbed");

    p = DefineType(VISIBLE, ENUMERATED, "VISIBLE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Unobscured");
    DefineEValue(p, 1L, "PartiallyObscured");
    DefineEValue(p, 2L, "FullyObscured");

    p = DefineType(CIRSTAT, ENUMERATED, "CIRSTAT", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Top");
    DefineEValue(p, 1L, "Bottom");

    p = DefineType(PROPCHANGE, ENUMERATED, "PROPCHANGE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "NewValue");
    DefineEValue(p, 1L, "Deleted");

    p = DefineType(CMAPCHANGE, ENUMERATED, "CMAPCHANGE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Uninstalled");
    DefineEValue(p, 1L, "Installed");

    p = DefineType(MAPOBJECT, ENUMERATED, "MAPOBJECT", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "Modifier");
    DefineEValue(p, 1L, "Keyboard");
    DefineEValue(p, 2L, "Pointer");

    p = DefineType(BYTEMODE, ENUMERATED, "BYTEMODE", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0x42L, "MSB first");
    DefineEValue(p, 0x6CL, "LSB first");

    p = DefineType(BYTEORDER, ENUMERATED, "BYTEORDER", NULL /* PrintENUMERATED */);
    DefineEValue(p, 0L, "LSB first");
    DefineEValue(p, 1L, "MSB first");

    p = DefineType(COLORCLASS, ENUMERATED, "COLORCLASS", NULL /* PrintENUMERATED */);
...
InitSetTypes()
{
    ...
    p = DefineType(SETofEVENT, SET, "SETofEVENT", NULL /* PrintSET */);
    ...
    p = DefineType(SETofPOINTEREVENT, SET, "SETofPOINTEREVENT", NULL /* PrintSET */);
    DefineEValue(p, 0x00000004L, "ButtonPress");
    DefineEValue(p, 0x00000008L, "ButtonRelease");
    DefineEValue(p, 0x00000010L, "EnterWindow");
    DefineEValue(p, 0x00000020L, "LeaveWindow");
    ...
    p = DefineType(SETofDEVICEEVENT, SET, "SETofDEVICEEVENT", NULL /* PrintSET */);
    DefineEValue(p, 0x00000001L, "KeyPress");
    DefineEValue(p, 0x00000002L, "KeyRelease");
    DefineEValue(p, 0x00000004L, "ButtonPress");
    DefineEValue(p, 0x00000008L, "ButtonRelease");
    ...
    p = DefineType(SETofKEYBUTMASK, SET, "SETofKEYBUTMASK", NULL /* PrintSET */);
    ...
    p = DefineType(SETofKEYMASK, SET, "SETofKEYMASK", NULL /* PrintSET */);
    DefineEValue(p, 0x0001L, "Shift");
    DefineEValue(p, 0x0002L, "Lock");
    DefineEValue(p, 0x0004L, "Control");
    DefineEValue(p, 0x0008L, "Mod1");
    ...
    p = DefineType(COLORMASK, SET, "COLORMASK", NULL /* PrintSET */);
    DefineEValue(p, 0x01L, "do-red");
    DefineEValue(p, 0x02L, "do-green");
    DefineEValue(p, 0x04L, "do-blue");

    p = DefineType(SCREENFOCUS, SET, "SCREENFOCUS", NULL /* PrintSET */);
...
InitValuesTypes()
{
    ...
    p = DefineType(WINDOW_BITMASK, SET, "WINDOW_BITMASK", NULL /* PrintSET */);
    ...
    p = DefineType(CONFIGURE_BITMASK, SET, "CONFIGURE_BITMASK", NULL /* PrintSET */);
    ...
    p = DefineType(GC_BITMASK, SET, "GC_BITMASK", NULL /* PrintSET */);
    ...
    p = DefineType(KEYBOARD_BITMASK, SET, "KEYBOARD_BITMASK", NULL /* PrintSET */);
